                                        ...
                                        <form action="#" className="mt-6" onSubmit={(event) => event.preventDefault()}>
                                            <div className="flex space-x-4">
                                                <div className="w-1/3">
                                                    ...
                                                    <DropDownListComponent cssClass="e-bigger" placeholder="+1" aria-label="choose your country code" role="listbox"></DropDownListComponent>
                                                </div>
                                                <div className="w-2/3">
                    ...
                    <section>
                        <div className="d-flex flex-column flex-lg-row min-vh-100">
                            <div className="col-12 col-lg-7 p-0">
                                <Image className="img-fluid w-100 h-100 object-fit" src="/assets/images/authentication/split-screen/split-screen.png" alt="image" width={32} height={32} sizes="100vw" />
                            </div>
