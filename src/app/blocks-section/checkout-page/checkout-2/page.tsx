                        ...
                        <div id="checkout-accordion" className="container-lg px-4 md:px-6 text-gray-700 dark:text-gray-300 py-20" style={{ minHeight: "1145px" }}>
                            <div className="m-auto w-full max-w-3xl">
                                ...
                                <div className="e-bigger mt-4 mb-6">
                                    <AccordionComponent className="border-t-0 border-l-0 border-r-0 border-b border-gray-200 dark:border-gray-600" expandMode="Single" role="button">
                                            ...
                                            <AccordionItemDirective header="Delivery information" expanded={true} content={() =>
                                                <div>
                                                    <div className="e-card pt-3 shadow-none border-transparent hover:border-primary-600 dark:hover:border-primary-400">
                                                        <div className="e-card-content !pt-1 !px-4">
                                                            <div className="e-bigger">
                                                                <RadioButtonComponent label="Trig Yellow - (+1) 432 434 2345" name="delivery" aria-label="trig yellow - (+1) 432 434 2345" role="radio"></RadioButtonComponent>
                                                            </div>
                                                    ...
                                                    <div className="e-card pt-3 mt-4 shadow-none border-transparent hover:border-primary-600 dark:hover:border-primary-400">
                                                        <div className="e-card-content !pt-1 !px-4">
                                                            <div className="e-bigger">
                                                                <RadioButtonComponent label="G8 - (+1) 432 000 2245" name="delivery" checked={true} aria-label="g8 - (+1) 432 000 2245" role="radio"></RadioButtonComponent>
                                                            </div>
                                                    ...
                                                    <div className="e-bigger mt-5">
                                                        <ButtonComponent className="e-flat m-1" type="button" content="Add new delivery information" iconCss="e-icons e-plus" aria-label="add new delivery information" role="button"></ButtonComponent>
                                                    </div>
                                                </div>}
                                ...
                                <form action="#" onSubmit={(event) => event.preventDefault()}>
                                    ...
                                    <div className="e-bigger mt-5">
                                        ...
                                        <TextAreaComponent placeholder="Enter additional information here" floatLabelType="Never" resizeMode="Vertical" aria-label="enter the additional information" role="textbox"></TextAreaComponent>
                                    </div>
                                    <div className="mt-5">
                                        <ButtonComponent className="w-full border-gray-300 dark:border-gray-500" type="button" content="Add new info" iconCss="e-icons e-plus" aria-label="add new info" role="button"></ButtonComponent>
                                    </div>
                                </form>
                                <div className="e-bigger mt-8">
                                    <AccordionComponent className="border-0 border-b rounded-0 border-light-subtle" role="button">
                                        <AccordionItemsDirective>
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div id="checkout-accordion" className="mx-auto row px-3 px-md-4 py-5" style={{ minHeight: "1076px" }} role="button">
                                            ...
                                            <AccordionItemDirective header="Delivery information" expanded={true} content={() =>
                                                <div>
                                                    ...
                                                    <div className="e-bigger mt-3">
                                                        <ButtonComponent cssClass="e-flat" content="Add new delivery information" type="button" iconCss="e-icons e-plus" aria-label="add new delivery information" role="button"></ButtonComponent>
                                                    </div>
                                                </div>}
                                            ></AccordionItemDirective>   
                                        </AccordionItemsDirective>
                                ...
                                <form action="#" onSubmit={(event) => event.preventDefault()}>
                                    ...
                                    <div className="row g-3 mt-0">
                                        <div className="col-md-6">
                                            ...
                                            <DropDownListComponent cssClass="e-bigger" placeholder="Country" aria-label="choose a country" role="button"></DropDownListComponent>
                                        </div>
                                        <div className="col-md-6">
                                            <label className="text-dark-emphasis fw-medium small mb-1">City</label>
                                            <DropDownListComponent cssClass="e-bigger" placeholder="City" aria-label="choose a city" role="button"></DropDownListComponent>
                                        </div>
                                    </div>
                                    <div className="row g-3 mt-0">
                                        <div className="col-md-6">
                                    ...
                                    <div className="e-bigger mt-3">
                                        ...
                                        <TextAreaComponent placeholder="Enter additional information here" resizeMode="Vertical" aria-label="enter the additional information" role="textbox"></TextAreaComponent>
                                    </div>
                                    <div className="mt-3">
                                        <ButtonComponent cssClass="e-block e-secondary" content="Add new info" type="button" iconCss="e-icons e-plus" aria-label="add new info" role="button"></ButtonComponent>
                                    </div>
                                </form>
                                <div className="e-bigger mt-4">
                                    <AccordionComponent className="border-0 border-bottom rounded-0 border-light-subtle" role="button">
                                        <AccordionItemsDirective>
                                            <AccordionItemDirective header="Payment methods" content=" "></AccordionItemDirective>
                                            <AccordionItemDirective header="Product" content=" "></AccordionItemDirective>
                                        </AccordionItemsDirective>
