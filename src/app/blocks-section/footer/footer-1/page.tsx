                    ...
                    <section className="bg-gray-50 dark:bg-gray-900">
                        <footer className="p-4 flex flex-col gap-6 sm:flex-row flex-wrap justify-between sm:items-center sm:px-6 xl:px-10">
                            ...
                            <div className="flex flex-col items-start gap-4 sm:flex-row sm:gap-3">
                                <a href="javascript:void(0);" className="text-base lg:text-sm font-medium py-1 text-primary-600 hover:underline dark:text-primary-400" aria-label="go to privacy policy">Privacy Policy</a>
                                <div className="border self-stretch my-1 hidden dark:border-gray-600 sm:block"></div>
                                <a href="javascript:void(0);" className="text-base lg:text-sm font-medium py-1 text-primary-600 hover:underline dark:text-primary-400" aria-label="go to cookie policy">Cookie Policy</a>
                                <div className="border self-stretch my-1 hidden dark:border-gray-600 sm:block"></div>
                                <a href="javascript:void(0);" className="text-base lg:text-sm font-medium py-1 text-primary-600 hover:underline dark:text-primary-400" aria-label="go to terms of service">Terms of Service</a>
                            </div>
                    ...
                    <section className="bg-body">
                        <footer className="p-3 px-sm-4 px-lg-5 d-flex flex-column gap-3 gap-sm-4 flex-sm-row flex-wrap justify-content-between align-items-sm-center">
                            ...
                            <div className="d-flex flex-column align-items-start justify-content-center gap-3 gap-sm-2 flex-sm-row">
                                <a href="javascript:void(0);" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small px-sm-2" aria-label="go to privacy policy">Privacy Policy</a>
                                <div className="border align-self-stretch border-light-subtle d-none d-sm-block"></div>
                                <a href="javascript:void(0);" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small" aria-label="go to cookie policy">Cookie Policy</a>
                                <div className="border align-self-stretch border-light-subtle d-none d-sm-block"></div>
                                <a href="javascript:void(0);" className="link-underline link-underline-opacity-0 link-underline-opacity-100-hover fw-medium small px-sm-2" aria-label="go to terms of service">Terms of Service</a>
                            </div>
