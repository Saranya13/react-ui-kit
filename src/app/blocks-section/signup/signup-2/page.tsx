                                        ...
                                        <div className="mt-10">
                                            ...
                                            <div className="flex items-center justify-center pt-10 space-x-4">
                                                <ButtonComponent cssClass="e-outline flex items-center justify-center px-4 py-2" type="submit">
                                                    <Image src="/react/essential-ui-kit/blocks/assets/images/common/brand-logos/png/google.png" width={20} height={20} alt="google logo" />
                                                </ButtonComponent>
                                                <ButtonComponent cssClass="e-outline flex items-center justify-center px-4 py-2" type="submit">
                                                    <Image src="/react/essential-ui-kit/blocks/assets/images/common/brand-logos/png/facebook.png" width={20} height={20} alt="facebook logo" />
                                                </ButtonComponent>
                                                <ButtonComponent cssClass="e-outline flex items-center justify-center px-4 py-2" type="submit">
                                                ...
                                                <ButtonComponent cssClass="e-outline flex items-center justify-center px-4 py-2" type="submit">
                                                    <Image src="/react/essential-ui-kit/blocks/assets/images/common/brand-logos/png/microsoft.png" width={20} height={20} alt="microsoft logo" />
                                                </ButtonComponent>
                                            </div>
                                ...
                                <div className="d-flex justify-content-center align-items-center bg-body">
                                    <div className="bg-body rounded-lg p-4 py-5 w-100" style={{ maxWidth: '450px' }}>
                                        ...
                                        <div className="d-flex justify-content-center mt-3 gap-3">
                                            ...
                                            <ButtonComponent cssClass="e-outline" type="submit">
                                                <Image src="/react/essential-ui-kit/blocks/assets/images/common/brand-logos/png/facebook.png" width={24} height={24} alt="facebook logo" />
                                            </ButtonComponent>
                                            <ButtonComponent cssClass="e-outline" type="submit">
