                        ...
                        <div className="w-full max-w-md rounded-lg p-4 py-12">
                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex items-center justify-center pt-10 space-x-4">
                                    ...
                                    <ButtonComponent cssClass="e-outline flex items-center justify-center px-4 py-2" type="submit" aria-label="sign in with facebook account" role="button">
                        ...
                        <div className="bg-body rounded-lg p-4 py-5 w-100" style={{ maxWidth: '450px' }}>
                            ...
                            <form action="#" className="mt-4 mb-4" onSubmit={(event) => event.preventDefault()}>
                                <div className="mb-3">
                                    ...
                                    <TextBoxComponent cssClass="e-bigger" type="text" placeholder="Name" aria-label="enter your name" />
                                </div>
                                <div className="mb-3">
                                    <label className="form-label mb-1 fw-medium text-dark-emphasis small">Email</label>
                                    <TextBoxComponent cssClass="e-bigger" type="email" placeholder="Email" aria-label="enter your email address" />
                                </div>
                                <div className="mb-3">
                                    <label className="form-label mb-1 fw-medium text-dark-emphasis small">Password</label>
                                    <TextBoxComponent cssClass="e-bigger" type="password" placeholder="Password" aria-label="enter your email password" />
                                </div>
                                <div className="mb-4">
                                    <CheckBoxComponent cssClass="e-bigger" aria-label="agree with terms and privacy policy" role="checkbox" />
                            ...
                            <span className="d-flex align-items-center justify-content-center gap-1 mt-3">
                                ...
                                <a href="javascript:void(0);" className="text-primary py-0 text-decoration-none fs-6 fw-medium" aria-label="sign in">Sign in</a>
                            </span>
                        </div>
                    </section>
                );
