                            ...
                            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10">
                                <div className="e-card e-bigger rounded-lg pt-6 pb-2 justify-start">
                                    ...
                                    <div className="e-card-header items-center">
                                        <span className="e-avatar e-avatar-circle e-avatar-large" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-6.jpg)" }}></span>
                                ...
                                <div className="e-card e-bigger rounded-lg pt-6 pb-2 justify-start">
                                    ...
                                    <div className="e-card-header items-center">
                                        <span className="e-avatar e-avatar-circle e-avatar-large" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-2.jpg)" }}></span>
                                        <div className="e-card-header-caption !pl-3">
                                            <div className="e-card-header-title">
