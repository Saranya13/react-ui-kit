                        ...
                        <div className="px-4 sm:px-6 py-20">
                            <div className="grid gap-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:gap-10">
                                <div className="e-card gap-2 rounded-lg e-bigger">
                                    <div className="e-card-header">
                                        <div className="e-card-image overflow-hidden rounded-lg h-56">
                                            <Image src="/react/essential-ui-kit/blocks/assets/images/card/image-title-description-card-button/adventure-trails.jpg" layout="fill" objectFit="cover" alt="adventure trails" />
                                        </div>
                                    </div>
                                ...
                                <div className="e-card gap-2 rounded-lg e-bigger">
                                    <div className="e-card-header">
                                        <div className="e-card-image overflow-hidden rounded-lg h-56">
                                            <Image src="/react/essential-ui-kit/blocks/assets/images/card/image-title-description-card-button/historic-landmarks.jpg" layout="fill" objectFit="cover" alt="historic landmarks" />
                                        </div>
                                    </div>
                                    <div className="e-card-content flex-1">
                                ...
                                <div className="e-card gap-2 rounded-lg e-bigger">
                                    <div className="e-card-header">
                                        <div className="e-card-image overflow-hidden rounded-lg h-56">
                                            <Image src="/react/essential-ui-kit/blocks/assets/images/card/image-title-description-card-button/vibrant-street-markets.jpg" layout="fill" objectFit="cover" alt="vibrant street markets" />
                                        </div>
                                    </div>
                                    <div className="e-card-content flex-1">
