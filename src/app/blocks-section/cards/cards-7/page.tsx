                            ...
                            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:gap-10 sm:gap-8">
                                <div className="e-card rounded-lg gap-6 e-bigger">
                                    <div className="e-card-image h-56">
                                        <Image src="/react/essential-ui-kit/blocks/assets/images/card/image-tags-card/gem-cities.jpg" layout="fill" objectFit="cover" alt="gem cities" />
                                    </div>
                                ...
                                <div className="e-card rounded-lg gap-6 e-bigger">
                                    <div className="e-card-image h-56">
                                        <Image src="/react/essential-ui-kit/blocks/assets/images/card/image-tags-card/natural-wonders.jpg" layout="fill" objectFit="cover" alt="natural wonders" />
                                    </div>
                                    <div className="e-card-stacked grow">
                                        <div className="e-card-content grow">
                                ...
                                <div className="e-card rounded-lg gap-6 e-bigger">
                                    <div className="e-card-image h-56">
                                        <Image src="/react/essential-ui-kit/blocks/assets/images/card/image-tags-card/historic-landmarks.jpg" layout="fill" objectFit="cover" alt="historic landmarks" />
                                    </div>
                                    <div className="e-card-stacked grow">
                                        <div className="e-card-content grow">
