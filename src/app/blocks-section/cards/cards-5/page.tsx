                            ...
                            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10">
                                <div className="e-card e-bigger rounded-lg justify-start">
                                    <div className="e-card-header items-center">
                                        <span className="e-avatar e-avatar-circle e-avatar-large" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-13.jpg)" }}></span>
                                ...
                                <div className="e-card e-bigger rounded-lg justify-start">
                                    <div className="e-card-header items-center">
                                        <span className="e-avatar e-avatar-circle e-avatar-large" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-12.jpg)" }}></span>
                                        <div className="e-card-header-caption !pl-3">
                                            <div className="e-card-header-title">
                        ...
                        <div className="px-3 px-sm-4 py-5" style={{ minHeight: "36rem" }}>
                            <div className="row g-xl-5 g-4">
                                ...
                                <div className="col-sm-6 col-lg-4">
                                    <div className="e-card shadow p-2 e-bigger h-100 justify-content-start">
                                        <div className="e-card-header align-items-center mb-2">
                                            <span className="e-avatar e-avatar-large e-avatar-circle" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-12.jpg)" }}></span>
                                            <div className="e-card-header-caption">
                                                <div className="e-card-header-title text-body">
