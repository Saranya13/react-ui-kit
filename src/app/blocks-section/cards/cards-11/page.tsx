                        ...
                        <div className="px-4 py-20 sm:px-6">
                            <div className="grid gap-6 sm:gap-8 lg:grid-cols-3 sm:grid-cols-2 xl:gap-10">
                                <div className="e-card rounded-lg pb-2 pt-6 e-bigger">
                                    <div className="e-card-content flex-1">
                                        <div className="e-card-image mb-6 overflow-hidden rounded-lg h-52">
                                            <Image src="/react-ui-kit/assets/images/card/featured-card/mountain-cabins.jpg" layout="fill" objectFit="cover" alt="mountain cabins" />
                                        </div>
                                ...
                                <div className="e-card rounded-lg pb-2 pt-6 e-bigger">
                                    <div className="e-card-content flex-1">
                                        <div className="e-card-image mb-6 overflow-hidden rounded-lg h-52">
                                            <Image src="/react-ui-kit/assets/images/card/featured-card/bustling-city-streets.jpg" layout="fill" objectFit="cover" alt="bustling city streets" />
                                        </div>
                                ...
                                <div className="e-card rounded-lg pb-2 pt-6 e-bigger">
                                    <div className="e-card-content flex-1">
                                        <div className="e-card-image mb-6 overflow-hidden rounded-lg h-52">
                                            <Image src="/react-ui-kit/assets/images/card/featured-card/seaside-resorts.jpg" layout="fill" objectFit="cover" alt="seaside resorts" />
                                        </div>
                                    ...
                                    <div className="e-card-header items-center">
                                        <span className="e-avatar e-avatar-large e-avatar-circle" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-13.jpg)" }}></span>
                                        <div className="e-card-header-caption mr-2">
                                            <div className="e-card-header-title">
                                    ...
                                    <div className="e-card e-bigger rounded-3 p-3">
                                        ...
                                        <div className="e-card-stacked flex-grow-1">
                                            ...
                                            <div className="e-card-header align-items-center px-0 pt-3">
                                                <span className="e-avatar e-avatar-circle" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-3.jpg)" }}></span>
                                ...
                                <div className="col-sm-6 col-lg-4 d-flex">
                                    <div className="e-card e-bigger rounded-3 p-3">
                                        ...
                                        <div className="e-card-stacked flex-grow-1">
                                            ...
                                            <div className="e-card-header align-items-center px-0 pt-3">
                                                <span className="e-avatar e-avatar-circle" style={{ backgroundImage: "url(/react-ui-kit/assets/images/common/avatar/avatar-13.jpg)" }}></span>
                                                <div className="e-card-header-caption me-2">
                                                    <div className="e-card-header-title text-body">
