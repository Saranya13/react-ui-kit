                                        ...
                                        <div className="flex justify-between pl-6 pr-2 py-3">
                                            <div className="flex items-center">
                                                <div className="indent-0 shrink-0">
                                                    {data.image && (
                                                        <img className="rounded-xl" src={`/react/essential-ui-kit/blocks/assets/images/search/${data.image}`} alt={`${data.title.toLowerCase()} logo`} layout="responsive" />
                                                    )}
                                                    {data.tag && (
                                                    ...
                                                    <div className="flex h-full items-center relative">
                                                        {data.avatar.map((img: string, index: number) => (
                                                            <span key={index} className="absolute e-avatar e-avatar-circle overflow-hidden" style={{ width: "32px", height: "32px", right: `${index * 22}px`, }}>
                                                                <img src={`/react/essential-ui-kit/blocks/assets/images/common/avatar/${img}`} className="w-100 h-100 object-cover" alt="logo" layout="responsive" width={100} height={100} />
                                                            </span>
                                                        ))}
                                                    </div>
                                                </div>
                                        ...
                                        <div className="d-flex justify-content-between ps-4 py-2 pe-2" style={{ textIndent: 0 }}>
                                            <div className="d-flex align-items-center">
                                                <div className="flex-shrink-0">
                                                    {data.image && (
                                                        <img className="rounded-3" src={`/react/essential-ui-kit/blocks/assets/images/search/${data.image}`} alt={`${data.title.toLowerCase()} logo`} layout="responsive" />
                                                    )}
                                                    {data.tag && (
                                                    ...
                                                    <div className="d-flex position-relative align-items-center h-100">
                                                        {data.avatar.map((img: string, index: number) => (
                                                            <span key={index} className="position-absolute e-avatar e-avatar-circle overflow-hidden" style={{ width: '32px', height: '32px', right: `${index * 22}px` }}>
                                                                <img src={`/react/essential-ui-kit/blocks/assets/images/common/avatar/${img}`} className="w-100 h-100 object-cover" alt="avatar" layout="responsive" width={100} height={100} />
                                                            </span>
                                                        ))}
                                                    </div>
                                                </div>
