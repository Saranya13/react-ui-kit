                                            ...
                                            <ColumnDirective field="product" headerText="Product" width="488" template={(data: any) => (
                                                <div className="flex items-center">
                                                    <div className="e-avatar e-avatar-small mr-6 shrink-0">
                                                        <Image src={"/react/essential-ui-kit/blocks/assets/images/return-block/return-form/" + data.product.productImage + ".png"} width={32} height={32} alt={data.product.productName.toLowerCase()} />
                                                    </div>
