                        ...
                        <div className="px-6">
                            <PagerComponent key={"advance-pagination1"} className="border-t-0 border-x-0 px-0 py-2 bg-transparent" template={() => (
                                <div className="!flex items-center gap-2 sm:gap-4 text-lg font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <span>
                                        <ButtonComponent className="e-primary" type="button" aria-label="go to page 1" role="button">1</ButtonComponent>
                                        <ButtonComponent className="e-flat" type="button" aria-label="go to page 2" role="button">2</ButtonComponent>
                                        <ButtonComponent className="e-flat" type="button" aria-label="go to page 3" role="button">3</ButtonComponent>
                                        <ButtonComponent className="e-flat hidden xl:inline-block" type="button" aria-label="go to page 4" role="button">4</ButtonComponent>
                                        <ButtonComponent className="e-flat hidden xl:inline-block" type="button" aria-label="go to page 5" role="button">5</ButtonComponent>
                                        <ButtonComponent className="e-flat hidden xl:inline-block" type="button" aria-label="go to page 6" role="button">6</ButtonComponent>
                                        <ButtonComponent className="e-flat hidden xl:inline-block" type="button" aria-label="go to page 7" role="button">7</ButtonComponent>
                                        <ButtonComponent className="e-flat hidden xl:inline-block" type="button" aria-label="go to page 8" role="button">8</ButtonComponent>
                        ...
                        <div className="px-4">
                            <PagerComponent key={"advance-pagination2"} className="border-top-0 border-start-0 border-end-0 px-0 py-2" template={() => (
                                <div className="d-flex align-items-center gap-2 fs-6 text-body">
                                    ...
                                    <span className="mx-1">
                                        <ButtonComponent className="rounded e-primary" type="button" aria-label="go to page 1" role="button">1</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded" type="button" aria-label="go to page 2" role="button">2</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded" type="button" aria-label="go to page 3" role="button">3</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded d-none d-xl-inline-block" type="button" aria-label="go to page 4" role="button">4</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded d-none d-xl-inline-block" type="button" aria-label="go to page 5" role="button">5</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded d-none d-xl-inline-block" type="button" aria-label="go to page 6" role="button">6</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded d-none d-xl-inline-block" type="button" aria-label="go to page 7" role="button">7</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded d-none d-xl-inline-block" type="button" aria-label="go to page 8" role="button">8</ButtonComponent>
                                        <ButtonComponent className="e-flat rounded" type="button" aria-label="more pages" role="button">...</ButtonComponent>
                                    </span>
