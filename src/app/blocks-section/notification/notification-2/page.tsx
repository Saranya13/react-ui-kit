            ...
            case 'tailwind':
                return (
                    <section className="bg-gray-50 dark:bg-gray-950">
                        <div key={'notification-2-tw'} className="w-full flex justify-end p-4 mx-auto" style={{ minHeight: '580px', maxWidth: '480px' }}>
                            ...
                            <DialogComponent ref={dialogRef} id={styles.notification} className="!bg-white dark:!bg-gray-800 rounded-lg overflow-hidden !border !ml-4 sm:!ml-0" width="448px" created={() => dialogRef.current?.show()} open={setDialogPosition}
                                header={() => (
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div key={'notification-2-bs'} className="w-100 d-flex justify-content-end p-3 mx-auto" style={{ minHeight: '580px', maxWidth: '480px' }}>
                            <div className="position-relative">
                                <ButtonComponent ref={buttonRef} cssClass="e-outline e-round" iconCss="sf-icon-notification-bell-02" type="button" onClick={toggleDialog}></ButtonComponent>
                                <span className="e-badge e-badge-danger e-badge-notification e-badge-overlap e-badge-circle mt-1 me-2">4</span>
                            </div>
                            <DialogComponent ref={dialogRef} id={styles.notification} className="bg-body rounded overflow-hidden border ms-3 ms-sm-0" width="448px" created={() => dialogRef.current?.show()} open={setDialogPosition}
                                header={() => (
                                    <div className="d-flex justify-content-between align-items-center px-3 py-2 my-1 border-bottom border-light">
