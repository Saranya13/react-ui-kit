            ...
            case 'tailwind':
                return (
                    <section className="bg-gray-50 dark:bg-gray-950">
                        <div key={'notification-1-tw'} className="w-full flex justify-end p-4 mx-auto" style={{ minHeight: '680px', maxWidth: '480px' }}>
                            ...
                            <DialogComponent ref={dialogRef} id={styles.notification} cssClass="!bg-white dark:!bg-gray-800 rounded-lg overflow-hidden !border !ml-4 sm:!ml-0" open={setDialogPosition} created={() => dialogRef.current?.show()}
                                header={() => (
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div key={'notification-1-bs'} className="w-100 d-flex justify-content-end p-3 mx-auto" style={{ minHeight: '680px', maxWidth: '480px' }}>
                            <div className="position-relative">
                                <ButtonComponent ref={buttonRef} cssClass="e-outline e-round" iconCss="sf-icon-notification-bell-02" type="button" onClick={toggleDialog}></ButtonComponent>
                                <span className="e-badge e-badge-danger e-badge-notification e-badge-overlap e-badge-circle mt-1 me-2">4</span>
                            </div>
                            <DialogComponent ref={dialogRef} id={styles.notification} cssClass="bg-body rounded overflow-hidden border ms-3 ms-sm-0" open={setDialogPosition} created={() => dialogRef.current?.show()}
                                header={() => (
                                                ...
                                                <div className="d-flex flex-column gap-1">
                                                    ...
                                                    {(data.id === 1 || data.id === 2) && (
                                                        <div className="d-flex gap-2 align-items-center mt-1">
                                                            <ButtonComponent cssClass="e-primary e-inherit" content="Accept" type="button"></ButtonComponent>
