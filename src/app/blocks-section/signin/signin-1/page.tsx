                            ...
                            <div className="w-full max-w-md rounded-lg px-4 py-14 md:px-6 md:py-20">
                                ...
                                <form action="#" className="mt-6 mb-6" onSubmit={(event) => event.preventDefault()}>
                                    <div className="mb-4">
                                        ...
                                        <TextBoxComponent cssClass="e-bigger" className="py-2" type="email" placeholder="Email" floatLabelType="Never" aria-label="enter the email address" role="textbox"></TextBoxComponent>
                                    </div>
                                    <div className="mb-5 relative">
                                        <label className="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Password</label>
                                        <TextBoxComponent cssClass="e-bigger" className="py-2" type="password" placeholder="Password" floatLabelType="Never" aria-label="enter the email password" role="textbox"></TextBoxComponent>
                                    </div>
                                    ...
                                    <div className="e-bigger mt-6">
                                        <ButtonComponent className="w-full e-primary" type="submit" onClick={(event) => event.preventDefault()} aria-label="sign in" role="button">Sign in</ButtonComponent>
                                    </div>
                                </form>
                                <div>
                                    ...
                                    <div className="flex items-center justify-center pt-10 gap-3 flex-col">
                                        <ButtonComponent className="w-full flex items-center justify-center px-4 py-2 e-outline" type="submit" aria-label="google" role="button">
                                        ...
                                        <ButtonComponent className="w-full flex items-center justify-center px-4 py-2 e-outline" type="submit" aria-label="microsoft" role="button">
                        ...
                        <div className="max-w-lg bg-body rounded-lg p-4 py-5 w-100" style={{ maxWidth: '508px' }}>
                            ...
                            <form action="#" onSubmit={(event) => event.preventDefault()}>
                                <div className="mb-3">
                                    ...
                                    <TextBoxComponent cssClass="e-bigger" className="py-2" type="email" placeholder="Email" floatLabelType="Never" aria-label="enter the email" role="textbox"></TextBoxComponent>
                                </div>
                                <div className="mb-3">
                                    <label className="form-label mb-1 fw-medium text-dark-emphasis small">Password</label>
                                    <TextBoxComponent cssClass="e-bigger" className="py-2" type="password" placeholder="Password" floatLabelType="Never" aria-label="enter the password" role="textbox"></TextBoxComponent>
                                </div>
                                <div className="d-flex align-items-center justify-content-between">
                                    <CheckBoxComponent cssClass="e-bigger" label="Remember me" aria-label="remember me" role="checkbox"></CheckBoxComponent>
                                    <a href="javascript:void(0);" className="text-primary fs-6 fw-medium text-decoration-none" style={{ paddingRight: 0, paddingTop: '4px' }} role="link">Forgot password?</a>
                                </div>
                                <div className="mt-4 e-bigger">
                                    <ButtonComponent className="e-block e-primary" type="submit" aria-label="signin" role="button">Sign in</ButtonComponent>
                                </div>
                            </form>
                            <div className="d-flex flex-wrap align-items-center justify-content-center mt-3 gap-1">
                                ...
                                <a href="javascript:void(0);" className="text-primary fs-6 fw-medium text-decoration-none" role="link">Sign up</a>
                            </div>
                            <div>
                                ...
                                <div className="d-flex flex-column mt-3 align-items-center justify-content-center gap-3">
                                    <ButtonComponent className="e-outline e-block d-flex align-items-center justify-content-center px-3 py-2" type="submit" aria-label="google" role="button">
                                    ...
                                    <ButtonComponent className="e-outline e-block d-flex align-items-center justify-content-center px-3 py-2" type="submit" aria-label="microsoft" role="button">
