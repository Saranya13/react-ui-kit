                ...
                return (
                    <section className="bg-gray-50 dark:bg-gray-950">
                        <div className="mx-auto w-full py-12 sm:px-6 px-4">
                            <GridComponent dataSource={data} key={"grid-1"} width="100%" height={498} rowHeight={48} role="grid">
                                <ColumnsDirective>
                ...
                return (
                    <section className="bg-body">
                        <div className="py-5 px-4 px-sm-6 mx-auto">
                            <GridComponent dataSource={data} key={"grid-2"} width="100%" height={498} rowHeight={48} role="grid">
                                <ColumnsDirective>
