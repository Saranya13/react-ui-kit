                ...
                return (
                    <section className="bg-white dark:bg-gray-950">
                        <div id={styles["quick-access-sidebar"]} className="flex relative" style={{ height: '600px' }}>
                            <SidebarComponent key={'quick-access-sidebar1'} className="bg-gray-50 dark:bg-gray-900 !border-r !border-gray-200 dark:!border-gray-700" width="72px" ref={sidebar} aria-label="main navigation menu" role="complementary" style={{ display: 'block' }}>
                                <div className="pt-6">
                                    ...
                                    <ListViewComponent className="border-0 e-bigger" dataSource={data} aria-label="quick navigation links" role="list" template={(data: any) => (
                            ...
                            <div className="p-3 bottom-0 left-0 absolute !right-full">
                                <ButtonComponent cssClass="e-large e-icons e-chevron-right e-round" type="button" aria-label="expand/collapse menu" role="button"></ButtonComponent>
                            </div>
                        </div>
                        {/* SB Code - Start */}
                ...
                return (
                    <section className="bg-body">
                        <div id={styles["quick-access-sidebar"]} className="d-flex position-relative" style={{ height: '600px' }}>
                            <SidebarComponent key={'quick-access-sidebar2'} className="border-end border-light-subtle" width="72px" ref={sidebar} aria-label="main navigation menu" role="complementary" style={{ display: 'block' }}>
