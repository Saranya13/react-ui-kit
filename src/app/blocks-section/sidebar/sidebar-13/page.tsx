                ...
                return (
                    <section className="bg-white dark:bg-gray-950">
                        <div id={styles["tasked-overview-sidebar"]} style={{ height: '600px' }}>
                            <SidebarComponent key={'tasked-overview-sidebar1'} className="bg-gray-50 dark:bg-gray-900 !border-l !border-gray-200 dark:!border-gray-700" width="328px" ref={sidebar} isOpen={true} position="Right" showBackdrop={true} style={{ display: 'block' }}>
            ...
            case 'bootstrap5':
                return (
                    <section className="bg-body">
                        <div id={styles["tasked-overview-sidebar"]} style={{ height: '600px' }}>
                            <SidebarComponent key={'tasked-overview-sidebar2'} width="328px" ref={sidebar} position="Right" showBackdrop={true} isOpen={true} style={{ display: 'block' }}>
